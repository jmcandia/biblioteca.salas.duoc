...
public class CarreraController {
    ...
    @GetMapping("/{codigo}")
    @Operation(summary = "Obtener una carrera por código", description = "")
    ...
    @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "Carrera a crear", required = true)
    @ApiResponses(@ApiResponse(responseCode = "200", description = "Carrera creada exitosamente", content = @Content(mediaType = "application/json", schema = @Schema(implementation = Carrera.class))))
    ...
    @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "Carrera a actualizar", required = true)
    @ApiResponses(@ApiResponse(responseCode = "200", description = "Carrera creada exitosamente", content = @Content(mediaType = "application/json", schema = @Schema(implementation = Carrera.class))))
